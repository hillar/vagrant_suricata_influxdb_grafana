...
(cd /opt/grafana/www/grafana-1.8.1; wget -q https://raw.githubusercontent.com/hillar/vagrant_suricata_influxdb_grafana/master/config.js.grafana;  mv config.js.grafana config.js)
